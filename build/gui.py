...
data_rtg = canvas.create_image(
    881.0,
    476.0,
    image=image_image_5
)

coppy_btn_image = PhotoImage(
    file=relative_to_assets("button_1.png"))
coppy_btn = Button(
    image=coppy_btn_image,
    borderwidth=0,
    bg = "#FFFFFF",
    highlightthickness=0,
...
button_image_2 = PhotoImage(
    file=relative_to_assets("clear_btn.png"))
clear_btn = Button(
...
button_image_3 = PhotoImage(
    file=relative_to_assets("scan_btn.png"))
scan_btn = Button(
...
scan_btn.place(
    x=263.0,
    y=565.0,
    width=197.82608032226562,
    height=70.0
)

image_image_7 = PhotoImage(
    file=relative_to_assets("image_7.png"))
logoApp = canvas.create_image(
    286.0,
    48.0,
    image=image_image_7
)
